...
export default function ProductPage() {
  ...
  useEffect(() => {
    async function fetchProduct() {
      try {
        const data = await client.fetch(productBySlugQuery, { slug: params.slug });
        setProduct(data);
      } catch (error) {
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-center py-20">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Proizvod nije pronađen</h1>
            <p className="text-gray-600 mb-8">Proizvod koji tražite ne postoji ili je uklonjen.</p>
            <a href="/proizvodi">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            <a href="/" className="hover:text-blue-600 transition-colors">Početna</a>
            <span>/</span>
            <a href="/proizvodi" className="hover:text-blue-600 transition-colors">Proizvodi</a>
            <span>/</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <a href={`tel:${SITE_CONFIG.company.phone.replace(/\s/g, '')}`} className="flex-1">
                  <Button size="lg" className="w-full" disabled={!product.inStock}>
                    ...
                    {product.inStock ? 'Poruči telefonom' : 'Kontaktiraj za dostupnost'}
                  </Button>
                </a>
                <a href={`mailto:${SITE_CONFIG.company.email}?subject=Upit za ${product.name}`}>
          ...
          {product.description && (
            <div className="mt-16 max-w-4xl">
              <h2 className="text-3xl font-bold text-gray-900 mb-8">Detaljan opis</h2>
