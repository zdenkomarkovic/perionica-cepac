      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Contact Info */}
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8">Dođite u posetu</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+381621083762" className="text-blue-600 hover:text-blue-700 transition-colors">
                      +381 62 108 3762
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:perionicacepac@gmail.com" className="text-blue-600 hover:text-blue-700 transition-colors">
              ...
              <div className="mt-8 bg-gray-200 rounded-xl h-64 flex items-center justify-center">
                <div className="text-center text-gray-500">
                  ...
                  <p>Mapa lokacije</p>
                  <p className="text-sm">Obilićeva 2a, Zrenjanin</p>
                </div>
              </div>
            </div>
